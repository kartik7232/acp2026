...
void compare_areas(Rectangle r1, Rectangle r2, Rectangle r3)
{
    ...
    {
        printf("%s has greatest area = %.2f", r1.name, r1.area);
    }
    else if (r2.area > r1.area && r2.area > r3.area)
    {
        printf("%s has greatest area = %.2f",r2.name,  r2.area);
    }
    else if(r3.area > r2.area && r3.area > r1.area)
    {
        printf("%s has greatest area = %.2f", r3.name, r3.area);

    }
    else
    {
        printf("All the rectangles are equal");
    }
}